...
const About = () => {
    ...
    const ref = useRef(null); // Ref for the About section
        ...
        const observer = new IntersectionObserver(
            ([entry]) => {
                if (entry.isIntersecting) {
                    ...
                    setInView(false); // Set inView to false when it goes out of view
                }
            },
            {
                ...
                <div className="AboutContainer">
                    ...
                    >
                        ...
                        <div className="icons">
                            ...
                            <a href="https://www.linkedin.com/in/dominic-ty-lau">
                                <svg
                                    viewBox="0 0 1024 1024"
                                    fill="white"
                                    height="2em"
